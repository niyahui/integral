...
function IsPC() {
    ...
    var bIsWechat = sUserAgent.match(/wxwork/i) == "wxwork";
    var bIsCE = sUserAgent.match(/windows ce/i) == "windows ce";
    var bIsWM = sUserAgent.match(/windows mobile/i) == "windows mobile";
    if (!(bIsIpad || bIsIphoneOs || bIsMidp || bIsUc7 || bIsUc || bIsAndroid || bIsWechat || bIsCE || bIsWM) ){
        flag = true;
    }
    return flag;
}
